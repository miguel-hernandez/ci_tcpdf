  ...
  this.update_accesos_question = function(texto){
      bootbox.confirm({
          ...
          callback: function (result) {
              if (result) {
                usuario_es.destroy_modal();
                usuario_es.update_accesos(obj_escolar.that,obj_escolar.col);
              } else {
...
/*
 *acciones en los check al seleccionar y deseleccionar el check
 * muestra mensajes de cambios y pasa parametros id en los divs
 */
$(document).ready(function () {
  usuario_es = new Usuario_escolar();
  usuario_es.deshabilita_pace();
