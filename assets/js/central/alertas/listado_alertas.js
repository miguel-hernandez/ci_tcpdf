...
function alimenta_campo_cct(){
  obj_cfcentral = new Alertas_central();
...
function Alertas_central(){
   _thisccentral = this;
 }

 Alertas_central.prototype.get_grid = function (offset){
 		$("#div_btns_grid").show();
 };


Alertas_central.prototype.get_view_buscadorcct = function (){
	$.ajax({
