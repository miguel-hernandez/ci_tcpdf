...
$(document).ready(function() {
    ...
    function add_update_data(item,data_array){
        ...
        $.ajax({
            type:"POST",
            url: base_url + "add_update_eval_sec",
            dataType: 'json',
            data:{
    ...
    $(document).on('click','._get_adicionales',function(e) {
        ...
        $.ajax({
            type:"POST",
            url: base_url + "get_adicionales_sec",
            dataType: 'json',
            data:forma,
            beforeSend: function () {
                $("#wait").modal("show");
    ...
    $(document).on('click','._upd_adicionales',function(e) {
        ...
        $.ajax({
            type:"POST",
            url: base_url + "upd_adicionales_sec",
            dataType: 'json',
            data:forma,
            beforeSend: function () {
                $("#wait").modal("show");
