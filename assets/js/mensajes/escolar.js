  ...
  $("#sg_1_table tbody tr").each(function (index)
  {
    ...
    $(this).children("td").each(function (index)
    {
      switch (index)
      {
        ...
        if(contenido == ""){
          var str_btn = "<button id='' type='button' onclick='redirect_mensaje("+id_mensaje+")' class='btn4Smartgrid'> <span class='glyphicon glyphicon-eye-open'></span></button>";
          $(this).append(str_btn);
        }
        break;
      }
...
function redirect_mensaje(idmensaje){
